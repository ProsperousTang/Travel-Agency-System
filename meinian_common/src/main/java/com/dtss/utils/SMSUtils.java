...
public class SMSUtils {
     ...
     *
     *
     *          LTAI4FxugG9NkQ2DFAD1TT7X
     *          H8dhZjvulQLdrLwmbRrePVfZPhQRPJ
     */
    public static void sendShortMessage(String phoneNumbers,String param) throws Exception{
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4FxugG9NkQ2DFAD1TT7X";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "H8dhZjvulQLdrLwmbRrePVfZPhQRPJ";// 你的accessKeySecret，参考本文档步骤2
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("DTSS商城");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_205816556");
